...
#define __setHistroy(history) (uiNamespace setVariable ["VDMJ_SQFConsole_History", history])
#define __getHistroy (uiNamespace getVariable "VDMJ_SQFConsole_History")
    ...
    _constructor = {
        ...
        _displayValue = {
            ...
            _collectInheritedProperties = {
                ...
                while {
                    ...
                    for "_i" from 0 to count _config - 1 do {
                        ...
                        _propertyNameLC = toLower configName _property;
                        if!(_propertyNameLC in _propertyNameLCList) then {
                            push(_propertyList, _property);
            ...
            _traverseConfigTree = {
                ...
                // swither ====
                if( _configOutputMode == 2 ) exitwith { "config entry: {" + (str _this) + "}" call _traverseTree };

                if( isText _this ) exitWith { _confName + " = " + (getText _this call _escapeString) + ";" call _writeLine };
            ...
            _traverseTree = {
                switch (toUpper typeName _this) do {
                    case "ARRAY" : {
                       ...
                       _to = count _this - 1;
                        if(
                            if( count toArray str _this < 40 ) then {
                                {
                            ...
                            ([_list, ", "] call _funcJoinString) call _writeLine;
                        } else {
